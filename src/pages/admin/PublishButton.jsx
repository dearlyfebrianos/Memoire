  ...
  return (
    <div className="relative">
      <button
        ...
        title={hasToken ? "Publish (Alt + P)" : "Setup GitHub (Alt + P)"}
            ...
            {status === "success" && result && (
              <div className="space-y-3">
                ...
                >
                  ...
                  >
                    ⏱ Vercel sedang rebuild. Tunggu <strong>30–60 detik</strong>
                    , lalu minta orang lain <strong>refresh halaman</strong> —
                    perubahan hidden/publik akan berlaku untuk semua.
                  </p>
                </div>
