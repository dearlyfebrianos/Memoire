...
function HiddenToggle({ isHidden, onToggle, label = "" }) {
  return (
    <button
      onClick={(e) => {
        e.stopPropagation();
...
function PhotoThumb({ photo, accentColor, onEdit, onDelete, onToggleHidden }) {
      ...
      <div style={{ position: "absolute", inset: 0 }}>
        {cover && !error ? (
          ...
          >
            ...
            <span
              className="font-body text-center px-2"
              style={{
                fontSize: "0.55rem",
...
function PhotoCard({ photo, chapter, onEdit, onDelete, onToggleHidden }) {
        ...
        {photo.hidden && (
          ...
          >
            ...
            <span className="font-body text-xs text-white">
              Foto ini disembunyikan dari publik
            </span>
          </div>
        )}

        <div
          className="absolute bottom-2 left-2 px-2 py-1 rounded-lg font-body text-xs"
          style={{
...
export default function AdminDashboard() {
  ...
  const hiddenChaptersCount = chapters.filter((c) => c.hidden).length;
  const hiddenPhotosCount = allPhotos.filter((p) => p.hidden).length;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {!localStorage.getItem("memoire_github_token") && (
          ...
          >
            ...
            >
              <strong>GitHub belum disetup.</strong> Setup untuk bisa publish ke
          ...
          >
                ...
                {[
                  {
                    step: "1",
                    label: "Tambah Foto",
                    desc: "Isi form dengan link foto, judul, caption, tags",
                    color: "#e8c4a0",
                  },
                  {
                    step: "2",
                    label: "Preview",
                    desc: "Foto langsung muncul di website kamu (local)",
                    color: "#c084fc",
                  },
                  {
                    step: "3",
                    label: "Publish",
                    desc: "Klik tombol Publish → otomatis push ke GitHub",
                    color: "#38bdf8",
                  },
                  {
                    step: "4",
                    label: "Live!",
                    desc: "Vercel rebuild ~30 detik → semua orang lihat",
                    color: "#4ade80",
                  },
                ].map((s) => (
                  <div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <GlassCard className="p-6">
                ...
                >
                  Upload foto ke chapter yang sudah ada dengan link URL.
                </p>
                <button
              ...
              <GlassCard className="p-6">
                ...
                <p
                  ...
                  style={{ color: "rgba(255,255,255,0.4)", lineHeight: "1.7" }}
                >
                  Buat kategori/chapter baru untuk koleksi foto.
                </p>
                <button
            ...
            <GlassCard className="p-6">
              ...
              >
                ...
                <span
                  ...
                  style={{ color: "rgba(255,255,255,0.3)" }}
                >
                  ({Math.min(allPhotos.length, 8)} ditampilkan)
                </span>
              </h3>
              {allPhotos.length === 0 ? (
                <div
        ...
        {activeTab === "chapters" && (
          ...
          >
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                onClick={() => setShowAddChapter(true)}
                className="px-4 py-2.5 rounded-xl font-body text-sm flex items-center gap-2"
                style={{
                  background: "rgba(192,132,252,0.1)",
                  border: "1px solid rgba(192,132,252,0.3)",
                  color: "#c084fc",
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        >
                          ...
                          {chapter.hidden && " · Tidak terlihat di publik"}
                        </p>
                      </div>
                    </div>
                          ...
                          {chapter.hidden && (
                            ...
                            >
                              ...
                              >
                                ...
                                gallery, dan home. Tapi masih bisa diakses via
                                URL langsung.
                              </p>
                            </div>
                          )}
